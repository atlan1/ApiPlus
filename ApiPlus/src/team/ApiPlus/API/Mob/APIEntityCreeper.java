...
/**
 * APIEntityCreeper class that functions as Mutable EntityCreeper
 * @author SirTyler
 * @version 1.0
 */
...
public class APIEntityCreeper extends EntityCreeper {
	...
	public APIEntityCreeper(World world) {
        ...
        if(sMob != null) {
            ...
            this.targetSelector.a(1, new PathfinderGoalNearestAttackableTarget(this, EntityHuman.class, (float) mob.getRange(), 0, true));
